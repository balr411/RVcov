...
TRUE. If the latter is used, we also need to specify **anno_file** or **anno**: 
...
subset of the 1000G whole genome sequencing data is available with this package,
and the file is:
...
And as stated already, we will use all 3 annotation definitions for our masks: 
