...
respectively, which are further apart. This is not unexpected, as the reference panel
...
agg_test(score_stat_file, vcf_file, chr, burden, wburden,
                     ...
                     altGroupFilePath = NULL, altCovariancePath = NULL,
                     altRaremetalPath = altRaremetalPath, mafThreshold = 0.01, gene = "NEB",
                     gene_start = gene_start, gene_end = gene_end, 
                     hwe = 0.000001)
```
